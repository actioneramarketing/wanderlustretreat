...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      />
      <div className="image-scrim-hero absolute inset-0" />

      <div className="container-wide relative z-10 w-full pb-16 pt-36 sm:pb-20 sm:pt-40">
        <motion.div
        ...
        >
          ...
          <p className="mb-4 font-serif text-xl text-cream/85 sm:text-2xl">
            {siteConfig.name}
          </p>
          <h1 className="font-serif text-[2.35rem] leading-[1.08] font-medium tracking-tight text-cream sm:text-5xl lg:text-[4rem]">
        ...
        <a
          href="#opening"
          className="mt-14 inline-flex items-center gap-2 text-xs tracking-[0.2em] text-cream/65 uppercase transition-colors hover:text-cream"
        >
          Scroll
